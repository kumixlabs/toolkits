/**
 * Region Constants
 * Provides mapping between region/state/province codes and their names
 */

/**
 * Object mapping region codes to their full names for countries worldwide
 * Uses ISO 3166-2 subdivision codes as keys
 *
 * @example
 * ```ts
 * import { REGIONS } from '@kumix/utils';
 *
 * // Get region name from code
 * const regionName = REGIONS['US-CA']; // 'California'
 *
 * // Check if a code is a valid region
 * const isValidRegion = 'CA-ON' in REGIONS; // true for Ontario, Canada
 *
 * // Get regions for a specific country
 * const usRegions = Object.entries(REGIONS)
 ...
 *   }));
 *
 * // Display region dropdown based on selected country
