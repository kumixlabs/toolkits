...
//  * @example
//  * ```typescript
//  * import { absoluteUrl } from '@kumix/utils';
//  *
 ...
 * @example
 * ```typescript
 * import { getUrlFromString } from '@kumix/utils';
 *
 * // Already valid URL
 ...
 * @example
 * ```typescript
 * import { getUrlObjFromString } from '@kumix/utils';
 *
 * // Already valid URL
 ...
 * @example
 * ```typescript
 * import { getUrlFromStringIfValid } from '@kumix/utils';
 *
 * // Already valid URL
