 ...
 * @example
 * ```typescript
 * import { UTMTags } from '@kumix/utils';
 *
 ...
 * @example
 * ```typescript
 * import { paramsMetadata } from '@kumix/utils';
 *
 ...
 * @example
 * ```typescript
 * import { constructURLFromUTMParams } from '@kumix/utils';
 *
 ...
 * @example
 * ```typescript
 * import { getUrlWithoutUTMParams } from '@kumix/utils';
 *
 ...
 * @example
 * ```typescript
 * import { createHref, UTMTags } from '@kumix/utils';
 *
 * // Basic usage
