 ...
 * @example
 * ```typescript
 * import { validateEmail } from '@kumix/utils';
 *
 * // Basic validation
 ...
 * @example
 * ```typescript
 * import { normalizeEmail } from '@kumix/utils';
 *
 * // Basic normalization
 ...
 * @example
 * ```typescript
 * import { isDisposableEmail } from '@kumix/utils';
 *
 * // Check for disposable email
 ...
 * @example
 * ```typescript
 * import { isBusinessEmail } from '@kumix/utils';
 *
 * // Check for business email
 ...
 * @example
 * ```typescript
 * import { getEmailDomain } from '@kumix/utils';
 *
 * // Extract domain
